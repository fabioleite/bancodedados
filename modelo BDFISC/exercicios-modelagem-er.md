...
A seguir estão exercícios práticos de modelagem entidade-relacionamento (MER) com exemplos da fiscalização tributária, usando cenários relacionados a EFD, NF-e e itens de NF-e.
...
Dica: use o conceito de um para muitos.
